...
DataMapper::MigrationRunner.migration( 3, :fix_notdnethack_trophies ) do
  up do
    notdnethack = helper_get_variant_for 'notdnethack'
    ...
    achievements.each {|achievement|
      Trophy.create variant: notdnethack, trophy: achievement[0], text: achievement[1], icon: achievement[2], row: achievement[3]
    }

    Trophy.create variant: notdnethack, trophy: "nine_keys", text: "Those were for replay value... (obtained all nine alignment keys)", icon: "m-nine-keys.png", row: 2
    Trophy.create variant: notdnethack, trophy: "dn_tour", text: "dNethack Tour: Played a game (at least 1000 turns) with all the shiny new races/roles in dNethack", icon: "m-dn-tour.png", row: 4
