$(document).ready(function() {
  var chartDom = document.getElementById('chart_finished_games_per_day');
  if (!chartDom) return;
  ...
  $.ajax({
    url: '/tmp/finished_games_per_day.csv',
    dataType: 'text',
    success: function(data) {
      ...
      chart.setOption({
        title: { text: 'Finished Games per Day', left: 'center' },
        tooltip: { trigger: 'axis' },
        xAxis: { type: 'time' },
        yAxis: { type: 'value', name: 'Finished Games per Day' },
